...
For more information, see [here](https://docs.docker.com/develop/develop-images/multistage-build/)
...
```
docker image pull your-account/nginx localhost:5000/myadmin/nginx
```

### Pushing an Image

```
docker image push your-account/nginx
```

```
docker image push your-account/nginx localhost:5000/myadmin/nginx
```
...
```
docker container create -t -i your-account/infinite --name infinite
```

### Running a Container

```
docker container run -it --name infinite -d your-account/infinite
```
...
```
docker image tag nginx your-account/nginx
```
